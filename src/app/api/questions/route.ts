...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = db.prepare('INSERT INTO questions (text, personalized_template, reverse_template) VALUES (?, ?, ?)').run(text.trim(), personalized_template?.trim() || null, reverse_template?.trim() || null)
